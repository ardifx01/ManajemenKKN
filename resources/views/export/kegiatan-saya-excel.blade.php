<table>
    <thead>
        ...
        <tr bgcolor="#f2f2f2">
            ...
            <th align="center" style="font-weight:bold;">Link Dokumentasi Foto</th>
            <th align="center" style="font-weight:bold;">Link Dokumentasi Video</th>
        </tr>
    </thead>
    <tbody>
        @foreach ($data as $val)
            <tr>
                ...
                <td>{{ $val->link_dokumentasi_foto ?? '-' }}</td>
                <td>{{ $val->link_dokumentasi_video ?? '-' }}</td>
            </tr>
        @endforeach
    </tbody>
</table>
